(() => {
  ...
  const TRANSLATIONS = {
    bg: {
      ...
      label_city: "Град",
      label_name: "Име и фамилия / Организация",
      ...
      opt_trainer: "Дресьор",
      ph_city: "Град",
      ph_name: "Име и фамилия / Организация",
      ph_contact: "+ ... или email@...",
    ...
    en: {
      ...
      label_city: "City",
      label_name: "Full Name / Organization",
      ...
      opt_trainer: "Trainer",
      ph_city: "City",
      ph_name: "Full name / Organization",
